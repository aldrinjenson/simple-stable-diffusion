...
st.markdown(
    ...
    - Use descriptive prompts to guide the image generation process. 

    ### Few Example prompts: 
        - "A ship sailing through stormy seas with thunder and lightning, rendered in a realistic style."
        ...
        - "photograph of BMW car, photorealistic, vivid, sharp focus, reflection, refraction, sunrays, very detailed, intricate, intense cinematic composition"
