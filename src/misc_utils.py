...
def getDownloadHref(base64_image_url):
    ...
    href = f'<a href="{base64_image_url}" download="{filename}" style="text-decoration: none; padding: 8px 16px; background-color: transparent; color: #eee; border: 1px solid #333; border-radius: 4px;">Save image ⬇</a>'
    return href
